...
import com.commerce.customer.service.common.exception.CustomerInfraException;
import com.commerce.customer.service.common.model.UserPrincipal;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void modifyResponseThroughError(HttpServletResponse response, HttpStatus httpStatus, String message) {
        ...
        try {
            ...
            throw new CustomerInfraException("Could not create ErrorResponse json!", e);
        } catch (IOException e) {

package com.commerce.payment.service.common.rest.config;

import com.commerce.payment.service.common.exception.PaymentInfraException;
import com.commerce.payment.service.common.model.UserPrincipal;
import com.commerce.payment.service.common.rest.client.CustomerHttpClient;
import com.commerce.payment.service.common.rest.handler.RestClientResponseErrorHandler;
...
//        return builder.baseUrl("http://customer-service")//todo fix
    ...
    private String convertDataToJson(UserPrincipal userPrincipal) {
        try {
            ...
            throw new PaymentInfraException("Could not create UserPrincipal object", e);
        }
    }
}

package com.commerce.inventory.service.common.security;

import com.commerce.inventory.service.common.exception.InventoryInfraException;
import com.commerce.inventory.service.common.model.UserPrincipal;
import com.commerce.inventory.service.common.rest.dto.ErrorResponse;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void modifyResponseThroughError(HttpServletResponse response, HttpStatus httpStatus, String message) {
        ...
        try {
            ...
            throw new InventoryInfraException("Could not create ErrorResponse json!", e);
        } catch (IOException e) {

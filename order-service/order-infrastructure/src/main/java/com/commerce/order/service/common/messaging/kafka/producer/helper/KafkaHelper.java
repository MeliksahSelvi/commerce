package com.commerce.order.service.common.messaging.kafka.producer.helper;
...
public class KafkaHelper {
    ...
    public <T> T getPayload(String payload, Class<T> outputType) {
        try {
            ...
            throw new OrderDomainException(String.format("Could not read %s object! %s", outputType.getName(), e.getMessage()));
        }
    }

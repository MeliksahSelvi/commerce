package com.commerce.shipping.service.common.security;

import com.commerce.shipping.service.common.exception.ShippingInfraException;
import com.commerce.shipping.service.common.model.UserPrincipal;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void modifyResponseThroughError(HttpServletResponse response, HttpStatus httpStatus, String message) {
        ...
        try {
            ...
            throw new ShippingInfraException("Could not create ErrorResponse json!", e);
        } catch (IOException e) {

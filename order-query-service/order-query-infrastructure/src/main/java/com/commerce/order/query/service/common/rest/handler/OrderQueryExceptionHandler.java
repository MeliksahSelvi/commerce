package com.commerce.order.query.service.common.rest.handler;

import com.commerce.order.query.service.common.exception.OrderNotFoundException;
import com.commerce.order.query.service.common.exception.OrderQueryDomainException;
...
public class OrderQueryExceptionHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OrderQueryExceptionHandler.class);

    @ResponseBody
    @ExceptionHandler(value = OrderQueryDomainException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleException(OrderQueryDomainException exception) {
    ...
    @ResponseBody
    @ExceptionHandler(value = OrderQueryInfraException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ErrorResponse handleException(OrderQueryInfraException exception) {
        logger.error(exception.getMessage(), exception);
        return buildErrorResponse(HttpStatus.BAD_REQUEST, exception.getMessage());
    }

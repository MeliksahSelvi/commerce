...
public class InventoryResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.commerce.kafka.model.InventoryStatus inventoryStatus;
   ...
   */
  public InventoryResponseAvroModel(java.lang.String sagaId, java.lang.Long customerId, java.lang.Long orderId, com.commerce.kafka.model.InventoryStatus inventoryStatus, com.commerce.kafka.model.OrderInventoryStatus orderInventoryStatus, java.util.List<java.lang.String> failureMessages) {
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: inventoryStatus = (com.commerce.kafka.model.InventoryStatus)value$; break;
   ...
   */
  public com.commerce.kafka.model.InventoryStatus getInventoryStatus() {
   ...
   * @param value the value to set.
   */
  public void setInventoryStatus(com.commerce.kafka.model.InventoryStatus value) {
   ...
   */
  public static com.commerce.kafka.model.InventoryResponseAvroModel.Builder newBuilder() {
    return new com.commerce.kafka.model.InventoryResponseAvroModel.Builder();
  }
   ...
   * @return A new InventoryResponseAvroModel RecordBuilder
   */
  public static com.commerce.kafka.model.InventoryResponseAvroModel.Builder newBuilder(com.commerce.kafka.model.InventoryResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.commerce.kafka.model.InventoryResponseAvroModel.Builder();
    } else {
      return new com.commerce.kafka.model.InventoryResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new InventoryResponseAvroModel RecordBuilder
   */
  public static com.commerce.kafka.model.InventoryResponseAvroModel.Builder newBuilder(com.commerce.kafka.model.InventoryResponseAvroModel other) {
    if (other == null) {
      return new com.commerce.kafka.model.InventoryResponseAvroModel.Builder();
    } else {
      return new com.commerce.kafka.model.InventoryResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InventoryResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.commerce.kafka.model.InventoryResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.commerce.kafka.model.InventoryResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sagaId)) {
        this.sagaId = data().deepCopy(fields()[0].schema(), other.sagaId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder setCustomerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder clearCustomerId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder setOrderId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder clearOrderId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder setInventoryStatus(com.commerce.kafka.model.InventoryStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder clearInventoryStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder setOrderInventoryStatus(com.commerce.kafka.model.OrderInventoryStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder clearOrderInventoryStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.InventoryResponseAvroModel.Builder clearFailureMessages() {
    ...
    public InventoryResponseAvroModel build() {
      try {
        ...
        record.inventoryStatus = fieldSetFlags()[3] ? this.inventoryStatus : (com.commerce.kafka.model.InventoryStatus) defaultValue(fields()[3]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.inventoryStatus = com.commerce.kafka.model.InventoryStatus.values()[in.readEnum()];

      this.orderInventoryStatus = com.commerce.kafka.model.OrderInventoryStatus.values()[in.readEnum()];

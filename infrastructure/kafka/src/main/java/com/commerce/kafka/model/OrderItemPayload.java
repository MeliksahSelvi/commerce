...
public class OrderItemPayload extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1985850562287244391L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItemPayload\",\"namespace\":\"com.commerce.kafka.model\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"orderId\",\"type\":\"long\"},{\"name\":\"productId\",\"type\":\"long\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}},{\"name\":\"totalPrice\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}}]}");
   ...
   */
  public static com.commerce.kafka.model.OrderItemPayload.Builder newBuilder() {
    return new com.commerce.kafka.model.OrderItemPayload.Builder();
  }
   ...
   * @return A new OrderItemPayload RecordBuilder
   */
  public static com.commerce.kafka.model.OrderItemPayload.Builder newBuilder(com.commerce.kafka.model.OrderItemPayload.Builder other) {
    if (other == null) {
      return new com.commerce.kafka.model.OrderItemPayload.Builder();
    } else {
      return new com.commerce.kafka.model.OrderItemPayload.Builder(other);
    }
  }
   ...
   * @return A new OrderItemPayload RecordBuilder
   */
  public static com.commerce.kafka.model.OrderItemPayload.Builder newBuilder(com.commerce.kafka.model.OrderItemPayload other) {
    if (other == null) {
      return new com.commerce.kafka.model.OrderItemPayload.Builder();
    } else {
      return new com.commerce.kafka.model.OrderItemPayload.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItemPayload>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.commerce.kafka.model.OrderItemPayload.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.commerce.kafka.model.OrderItemPayload other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder setOrderId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder clearOrderId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder setProductId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder setTotalPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.commerce.kafka.model.OrderItemPayload.Builder clearTotalPrice() {
      totalPrice = null;
